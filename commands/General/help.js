...
class Help extends Command {
	...
	async run (message, args, data) {
		...
		embed.addField("\u200B", message.translate("misc:STATS_FOOTER", {
			donateLink: "https://trakteer.id/sitou",
			dashboardLink: "https://dashboard.sitou-bot.xyz/",
			inviteLink: await this.client.generateInvite({
				permissions: [Discord.Permissions.FLAGS.ADMINISTRATOR]
			}),
			githubLink: "https://github.com/Sitouxz",
			supportLink: "https://discord.gg/VWPnE5jjTz"
		}));
